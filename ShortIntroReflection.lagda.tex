...
Then we see that \AgdaBound{e} is equal to \AgdaFunction{id} \AgdaBound{e}, which is equal to \AgdaFunction{⟦\AgdaUnderscore{}⟧} \AgdaOperator{\AgdaFunction{∘}} \AgdaFunction{[\AgdaUnderscore{}]} \AgdaBound{e}, which is equal to \AgdaFunction{⟦\AgdaUnderscore{}⟧} \AgdaOperator{\AgdaFunction{∘}} \AgdaBound{f} \AgdaOperator{\AgdaFunction{∘}} \AgdaFunction{[\AgdaUnderscore{}]} \AgdaBound{e}.
